...
<%
    ...
    EmployeEtablissement etab = etss.findbyEtablissementByEmail(session.getAttribute("umail").toString());
%>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card card-small mb-4">
                                    ...
                                    <input id="fonction" type="hidden" name="fonction" value="<%= etab.getEmploye().getFonction() %>" />
                                    <input id="empetab" type="hidden" name="empetab" value="<%= etab.getEtablissement().getId() %>" />
                                ...
                                <div class="card card-small mb-4">
                                    ...
                                    <div class="card-body p-0 pb-3" id="divtable">
                                        <table class="table mb-0" id="empTable">
                                            ...
                                            <tbody id="container">
                                                <% for (EmployeEtablissement et : etss.findEmployeByEtab(etab.getEtablissement().getId())) {
                                                   String df = "---";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><%= df %></td>
                                                    <td><Button  class="btn btn-info updateE" idEt="<%= et.getEtablissement().getId() %>" v="<%= et.getEmploye().getId()%>">Modifier</Button></td>
                                                    <td><Button  class="btn btn-danger deleteE" idEt="<%= et.getEtablissement().getId() %>" v="<%= et.getEmploye().getId()%>">Supprimer</Button></td>
                                                </tr>
                                                <% }%>
                                            </tbody>
                                        </table>
